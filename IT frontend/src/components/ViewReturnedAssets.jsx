...
//       .then(res => {
//         console.log("Returned Assets:", res.data); // Debugging log
//         setReturns(res.data);
//       })
//       .catch(err => console.error('Failed to fetch returned assets', err));
//   }, []);
...
//           {returns.length === 0 ? (
//             <tr>
//               <td colSpan="8" style={{ textAlign: 'center' }}>No returned assets found</td>
//             </tr>
//           ) : (
//             returns.map((item) => (
//               <tr key={item._id}>
...
//                 <td>{item.assetId?.modelNumber || 'N/A'}</td>
...
//     applyFilters(value, selectedEmployee);
//   };
...
//           {filteredReturns.length === 0 ? (
//             <tr>
//               <td colSpan="10" style={{ textAlign: 'center' }}>No returned assets found</td>
//             </tr>
//           ) : (
//             filteredReturns.map((item) => (
//               <tr key={item._id}>
...
const ViewReturnedAssets = () => {
  ...
  //   try {
  //     await axios.delete(`http://localhost:5000/api/returns/${id}`);
